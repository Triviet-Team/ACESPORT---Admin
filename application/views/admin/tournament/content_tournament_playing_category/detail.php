    ...
    <div class="ui-wid">
        ...
        <div class="form-mid">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    <select tournament="<?= @$info->tournament ? @$info->tournament : '' ?>" class="custom-select tournament" id="tournament" name="tournament">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    <select noi_dung="<?= @$info->tournament_playing_category_id ? @$info->tournament_playing_category_id : ''?>" class="custom-select noi-dung" id="noi_dung" name="noi_dung">
            ...
            <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Danh sách lịch thi đấu vòng loại</label>
                    <div class="col-sm-10">
