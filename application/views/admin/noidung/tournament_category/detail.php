        ...
        <div class="form-mid">
            <form action="" method="POST" id="frmSubmit" enctype="multipart/form-data">
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="editor" rows="3" name="vn_sapo"><?= isset($info->vn_sapo) ? $info->vn_sapo : set_value('vn_sapo') ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="showFile">
                            ...
                            <?php } else { ?>
                                <img id="profile-img-tag" src="<?= base_url('uploads/images/productcategory/842_1024/' . $info->image_link) ?>" alt="No-Img">
                            <?php } ?>
                        </div>
                    </div>
                </div> -->
        ...
        <div class="form-bottom">
            <div class="horControlB">
                <ul>
                    ...
                    <li>
                        <a class="eCancel" href="javascript:(0)" onclick="location.href = '<?= base_url('admincp/product_category') ?>'">
                            <span>Cancel</span>
                        </a>
                    </li>
                </ul>
