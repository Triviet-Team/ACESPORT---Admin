            ...
            <form id="frmSubmit" action="" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 email" id="email">
						<input type="text" name="email_1" value="<?= @$general->email_1 ? $general->email_1 : '' ?>" class="form-control col-sm-12 add-email" style="margin-top:5px;">                                      
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 email" id="email">
						<input type="text" name="email_2" value="<?= @$general->email_2 ? $general->email_2 : '' ?>" class="form-control col-sm-12 add-email" style="margin-top:5px;">                                      
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="skype" value="<?= @$general->skype ? $general->skype : '' ?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="zalo" value="<?= @$general->zalo ? $general->zalo : '' ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
