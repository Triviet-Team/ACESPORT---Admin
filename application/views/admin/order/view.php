                                	 ...
                                	 <div class="image_thumb">
                                        <?php 
                                                ...
                                                if(!empty($link_images[$k])){
                                                    $link_img = base_url().'uploads/images/product/400_400/'.$link_images[$k];
                                                }
                                        ?>
                                        <img src="<?= $link_img ?>" alt=""/>
                                    </div>
                                    <div class="info_products">
                                        <b><a href="<?=base_url('chi-tiet-san-pham/').$vn_slugs[$k]?>.html"><?= $vn_names[$k] ?></a></b>
                                    </div>
                                </td>
    				 ...
    				 <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr class="text-center">
                          ...
                          <td><?= lang('modeofpayment_' . $view->modeofpayment) ?></td>
                          <td><?= lang('methodofreceive_' . $view->methodofreceive) ?></td>
