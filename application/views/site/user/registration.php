      ...
      <section class="member-page">
                    ...
                    <div class="col-md-12">
						<form id="signup-form" action="<?= base_url('dang-ky-tai-khoan.html') ?>" novalidate="novalidate" method="POST">
							<div class="md-form mt-5">
								...
								<input class="form-control validation" id="name_signup" type="text" name="nickname" value="<?php echo set_value('nickname'); ?>"/>
								<label for="name_signup">Nickname (<span style="color: red">*</span>)</label>
								<div class="error"><?= form_error('nickname') ?></div>
							</div>
							<div class="md-form mt-5">
								...
								<label for="email_signup">Email  (<span style="color: red">*</span>)</label>
								<div class="error"><?= form_error('email') ?></div>
							</div>
							<div class="md-form mt-5">
								<i class="mdi mdi-account-key prefix grey-text"></i> 
								<input type="text" id='nick_signup' name="username" class="form-control validation" value="<?php echo set_value('username'); ?>">
								<label for="nick_signup"> Tên đăng nhập (Username)  (<span style="color: red">*</span>)</label>
							...
							<div class="md-form mt-5">
								...
								<label for="password_signup"> Mật khẩu  (<span style="color: red">*</span>)</label>
							...
							<div class="md-form mt-5">
								...
								<label for="passwordEq_signup"> Nhập lại mật khẩu  (<span style="color: red">*</span>)</label>
       ...
       <!--                         <a href="#" onclick="document.getElementById('captcha').src = '<?= base_url('application/securimage')?>securimage/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a>-->
							...
							<div class="login-footer">
								<div class="row">
									<div class="col-sm-9">
										<h5><span>Bạn đã là thành viên? </span><a style="color: #055699" class="login-btn">Đăng nhập ngay</a>
										</h5>
									</div>
								</div>
							</div>
