...
class Product_category extends MY_Controller {
    ...
    public function index() {
        ...
        $this->data['temp'] = 'product_category/index';
    ...
    public function detail($id = 0) {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($pid) {
                    redirect(base_url('admincp/product_category?id=&vn_name=&pid=' . $pid));
                } else {
                    redirect(base_url() . 'admincp/product_category/index/');
                }
            }
        }
        ...
        $this->data['temp'] = 'product_category/detail';
        $this->load->view('admin/main', $this->data);
    }
        ...
        switch ($action) {
            case 'del':
                ...
                if ($check_catalog) {
                    ...
                    $check_product_sub = $this->product_m->check_exists('cid in (' . $id_object . ')');
                    ...
                    if ($check_product_sub) {
                        ...
                        if ($this->product_m->update_rule('cid in (' . $id_object . ')', array('status' => 3))) {
                    ...
                    $check_product = $this->product_m->check_exists('cid = ' . $id . '');
            ...
            case 'del_all':
                ...
                if ($check_catalog_all) {
                    ...
                    $check_product_sub = $this->product_m->check_exists('cid in (' . $id_object_all . ')');
                    $input = 'id in(' . $id_object_all . ')';

                    //Check danh mục có tồn tại sản phẩm k
                    if ($check_product_sub) {
                        // Xóa toàn bộ sản phẩm của danh mục con đó xong xóa danh mục
                        if ($this->product_m->update_rule('cid in (' . $id_object_all . ')', array('status' => 3))) {
                            if ($this->category->update_rule($input, array('status' => 3))) {
                    ...
                    $check_product_all = $this->product_m->check_exists('cid in (' . $array_id . ')');
                    //Check xem danh muc co san pham k
            ...
            case 'disable':
                ...
                if ($check_catalog) {
                    ...
                    if ($check_product_sub) {
                        ...
                        if ($this->product_m->update_rule('cid in (' . $id_object . ')', array('status' => 2))) {
            ...
            case 'disable_all':
                ...
                if ($check_catalog_all) {
                    ...
                    if ($check_product_sub) {
                        // Xóa toàn bộ sản phẩm của danh mục con đó xong xóa danh mục
                        if ($this->product_m->update_rule('cid in (' . $id_object_all . ')', array('status' => 2))) {
                            if ($this->category->update_rule($input, array('status' => 2))) {
    ...
    public function clean_trash() {
        ...
        if ($object_id_del) {
            ...
            $check_del_product = $this->product_m->get_list($input);

            if ($check_del_product) {
                if ($this->product_m->del_rule('cid in (' . $object_id_del . ')')) {
        ...
        redirect(base_url('admincp/product_category'));
    }
