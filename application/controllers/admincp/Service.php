...
class Service extends MY_Controller {
    ...
    public function index() {
        ...
        $config['base_url'] = base_url('admincp/service');
    ...
    public function detail($id = 0) {
        ...
        // print_r($_SERVER);
        $input = array();
        $input['where'] = array('pid' => 0, 'status' => 1, 'id' => 4);
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($cid) {
                    redirect(base_url('admincp/service?id=&vn_name=&cid=' . $cid));
                } else {
                    redirect(base_url() . 'admincp/service');
                }
            }
        }
