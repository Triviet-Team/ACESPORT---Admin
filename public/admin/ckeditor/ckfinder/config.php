...
$config['LicenseName'] = 'Thien';
$config['LicenseKey'] = 'L3FYTJ9W5SU9D44N5MABFKNHYQJ57EPE';
...
*/
$baseUrl = 'http://' . $_SERVER['HTTP_HOST'] .'/cibeta2/uploads/ckeditor/';
//$baseUrl = 'http://localhost/dhs/uploads/images/ckeditor/';
/*
